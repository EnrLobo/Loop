...
public class TesteLoop {
    ...
    public static void main(String[] args) {
        ...
        Jogo loja = new Jogo();
        Jogo jogo1 = new Jogo("Elden ring", "12/03/21", "From Software", "Bandai");
        Jogo jogo2 = new Jogo("Cyberpunk 2077", "12/03/21", "CD Project Red", "CD Project");
        Jogo jogo3 = new Jogo("Call of Duty", "12/03/21", "Pimba Games", "Instituto Company");
        Jogo jogo4 = new Jogo("Sniper Elite", "12/03/21", "United States of America", "USA studios");
        Jogo jogo5 = new Jogo("Sky Lines", "12/03/21", "Cities", "Countries");
        Jogo jogo6 = new Jogo("Spider Man", "12/03/21", "Marvel", "DC");
